            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-8 position-relative mb-4 mb-md-0">
                    ...
                    <div class='d-flex'>
                        ...
                        <p class='mr-4 fs-bolder' style='color:#FF8876'>RIDE THE WAVE</p>
                        <p class='mr-4 fs-bolder' style='color:#FF8876'>||</p>
                        <p class='mr-4 fs-bolder' style='color:#FF8876'>WRITE THE JOURNEY</p>
                        <p class='mr-4 fs-bolder' style='color:#FF8876'>||</p>
                        <p class='mr-4 fs-bolder' style='color:#FF8876'>TAKE THE DARE </p>
                ...
                <!-- Image -->
                <div class="col-lg-4 position-relative sidehero">

                    <img src="{{url('assets/images/sidehero.png')}}" class="rounded" alt="">
