                            ...
                            <div class="owl-item">
                                <div class="album">
                                    <div class="album__cover">
                                        ...
                                        <span class="main__list main__list--playlist">
                                            <a data-playlist="" data-title="{{ $beat->title }}" data-artist="{{ $beat->author->name ?? 'Unknown' }}" href="{{ $beat->audio_url }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Z"></path>
                                                </svg>
                                            </a>
                                        </span>
                                    </div>
