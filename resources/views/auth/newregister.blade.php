            ...
            <div class="col-12">
                <div class="sign">
                    <div class="sign__content">
                        <form action='{{ route("register") }}' method='post' class="sign__form">@csrf
                            ...
                            <div class="sign__group">
                                <input name='phone' type="phone" class="sign__input" placeholder="Phone Number">
                            </div>
                            ...
                            <div class="sign__group">
                                <select required name='user_type' class="sign__input">
