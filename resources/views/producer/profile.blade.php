                ...
                <div class="card car-transparent">
                    <div class="card-body p-0">
                        <div class="profile-image position-relative">
                            ...
                            <img src="{{ asset('producerImage/' . $user->logo) }}" class="img-fluid rounded w-100" alt="">
                            @else
                            <img src="https://dnasoundstudio.com/producers/assets/images/music-dashboard/feature-album/05.png" class="img-fluid rounded w-100" alt="">
                            @endif
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-block card-stretch card-height">
                    <div class="card-body text-center">
                        ...
                        <h2 class="mb-2 mt-3 text-success">Plan : Free </h2>
