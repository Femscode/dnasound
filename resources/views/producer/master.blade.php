...
<!-- Mirrored from demosc.chinaz.net/Files/DownLoad/moban/202105/moban5489/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2024 12:31:12 GMT -->
...
<head>
	...
	<!-- Favicons -->
	<link rel="icon" type="image/png" href="icon/favicon-32x32.html" sizes="32x32">
	<link rel="apple-touch-icon" href="icon/favicon-32x32.html">
	...
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Hanunoo&family=SUSE:wght@100..800&display=swap" rel="stylesheet">
	...
	<header class="header">
		<div class="header__content">
			...
			<form action="#" class="header__search">
				<input type="text" placeholder="Artist, beat or producer">
			...
			<div class="header__actions">
				...
				<div class="header__action header__action--signin">
					<a href='/logout' onclick='return confirm("Are you sure you want to logout")' class="header__action-btn" href="signin.html">
						<span>Sign Out</span>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			<li class="sidebar__nav-item">
				<a href="/dashboard" class="sidebar__nav-link sidebar__nav-link--active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
			...
			<li class="sidebar__nav-item">
				<a href="/beat-producers" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path d="M12.3,12.22A4.92,4.92,0,0,0,14,8.5a5,5,0,0,0-10,0,4.92,4.92,0,0,0,1.7,3.72A8,8,0,0,0,1,19.5a1,1,0,0,0,2,0,6,6,0,0,1,12,0,1,1,0,0,0,2,0A8,8,0,0,0,12.3,12.22ZM9,11.5a3,3,0,1,1,3-3A3,3,0,0,1,9,11.5Zm9.74.32A5,5,0,0,0,15,3.5a1,1,0,0,0,0,2,3,3,0,0,1,3,3,3,3,0,0,1-1.5,2.59,1,1,0,0,0-.5.84,1,1,0,0,0,.45.86l.39.26.13.07a7,7,0,0,1,4,6.38,1,1,0,0,0,2,0A9,9,0,0,0,18.74,11.82Z" />
					</svg> <span>Producers</span></a>
			</li>

			<li class="sidebar__nav-item">
				<a href="/beat/trending" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path d="M21.65,2.24a1,1,0,0,0-.8-.23l-13,2A1,1,0,0,0,7,5V15.35A3.45,3.45,0,0,0,5.5,15,3.5,3.5,0,1,0,9,18.5V10.86L20,9.17v4.18A3.45,3.45,0,0,0,18.5,13,3.5,3.5,0,1,0,22,16.5V3A1,1,0,0,0,21.65,2.24ZM5.5,20A1.5,1.5,0,1,1,7,18.5,1.5,1.5,0,0,1,5.5,20Zm13-2A1.5,1.5,0,1,1,20,16.5,1.5,1.5,0,0,1,18.5,18ZM20,7.14,9,8.83v-3L20,4.17Z" />
					</svg> <span>Trending Beats</span></a>
			</li>
			...
			<li class="sidebar__nav-item">
				<a href="/beat/my-beats" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					...
					</svg> <span>My Beats</span></a>
			</li>

			<!-- collapse -->
			<li class="sidebar__nav-item">
				<a class="sidebar__nav-link" data-toggle="collapse" href="/storage" role="button" aria-expanded="false" aria-controls="collapseMenu1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
			...
			<div class="row">
				<div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
					<div class="footer__logo">
						<img src="/assets/images/logo/png/logo4.png" alt="">
					</div>
					<p class="footer__tagline">Join us in making the every beat count. We are proud to be the link every producer and music artist needs.</p>
					<div class="footer__links">
						<a href="mailto:support@dnastudio.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
				...
				<div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
					<div class="row">
						...
						<div class="col-6">
							<div class="footer__nav">
								<a href="/profile">Profile</a>
								<a href="/create-beath">Upload Beat</a>
								<a href="#">Artists</a>
								<a href="#">Producers</a>
							</div>
						</div>
...
<!-- Mirrored from demosc.chinaz.net/Files/DownLoad/moban/202105/moban5489/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2024 12:37:11 GMT -->
