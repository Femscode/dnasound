            ...
            <div class="col-12">
                <div class="hero owl-carousel" id="hero">
                    ...
                    <div class="hero__slide" data-bg="/dna/img/home/slide3.jpg">
                        <h2 class="hero__title">Get that beat for your next hit!</h2>
                        <p class="hero__text">Join us in making the every hit count. We are proud to be the link every producer and music artist needs.</p>
                        <div class="hero__btns">
                            <a href="#" class="hero__btn">About Us</a>
                        </div>
                    </div>
